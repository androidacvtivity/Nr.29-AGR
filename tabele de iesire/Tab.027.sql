...
--------------------------------------------------------------------------------
  ...
  ROUND((NVAL(COL3)+NVAL(COL3_1)) + (NVAL(COL5)+NVAL(COL5_1)),0) AS COL7,
  ROUND((NVAL(COL4)+NVAL(COL4_1)) + (NVAL(COL5)+NVAL(COL5_1)),0) AS COL8
FROM
(
SELECT
  ...
  NVAL(SUM(CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' AND D.RIND IN ('1130') THEN D.COL1 END)) AS COL1,
  NVAL(SUM(CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' AND D.RIND IN ('1160') THEN D.COL1 END)) AS COL1_1,
  NVAL(SUM(CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' AND D.RIND IN ('1130') THEN D.COL2 END)) AS COL2,
  NVAL(SUM(CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' AND D.RIND IN ('1160') THEN D.COL2 END)) AS COL2_1,
  NVAL(SUM(CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' AND D.RIND IN ('1130') THEN D.COL3 END)) AS COL3,
  NVAL(SUM(CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' AND D.RIND IN ('1160') THEN D.COL3 END)) AS COL3_1,
  NVAL(SUM(CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' AND D.RIND IN ('1130') THEN D.COL4 END)) AS COL4,
  NVAL(SUM(CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' AND D.RIND IN ('1160') THEN D.COL4 END)) AS COL4_1,
  NVAL(SUM(CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' AND D.RIND IN ('1130') THEN D.COL5 END)) AS COL5,
  NVAL(SUM(CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' AND D.RIND IN ('1160') THEN D.COL5 END)) AS COL5_1
...
SELECT
  ...
  NVAL(SUM(CASE WHEN D.RIND IN ('1130') THEN D.COL1 END)) AS COL1,
  NVAL(SUM(CASE WHEN D.RIND IN ('1160') THEN D.COL1 END)) AS COL1_1,
  NVAL(SUM(CASE WHEN D.RIND IN ('1130') THEN D.COL2 END)) AS COL2,
  NVAL(SUM(CASE WHEN D.RIND IN ('1160') THEN D.COL2 END)) AS COL2_1,
  NVAL(SUM(CASE WHEN D.RIND IN ('1130') THEN D.COL3 END)) AS COL3,
  NVAL(SUM(CASE WHEN D.RIND IN ('1160') THEN D.COL3 END)) AS COL3_1,
  NVAL(SUM(CASE WHEN D.RIND IN ('1130') THEN D.COL4 END)) AS COL4,
  NVAL(SUM(CASE WHEN D.RIND IN ('1160') THEN D.COL4 END)) AS COL4_1,
  NVAL(SUM(CASE WHEN D.RIND IN ('1130') THEN D.COL5 END)) AS COL5,
  NVAL(SUM(CASE WHEN D.RIND IN ('1160') THEN D.COL5 END)) AS COL5_1
