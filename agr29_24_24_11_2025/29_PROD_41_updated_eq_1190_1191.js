...
//------------------------------------------------------
// 45-004.1  Cap.I: Rând.1190 col.3 = col.4  și  Rând.1191 col.3 = col.4
function validate45_004_1(values) {
    ...
    for (var i = 0; i < rows.length; i++) {
        ...
        var c3 = roundToDecimal(NVAL(values["CAP1_R" + r + "_C3"]), 1);
        var c4 = roundToDecimal(NVAL(values["CAP1_R" + r + "_C4"]), 1);

        if (c3 !== c4) {
            webform.errors.push({
                'fieldName': 'CAP1_R' + r + '_C3',
                'weight': 6,
                'msg': Drupal.t('Cod eroare: 45-004.1. Rând.@r col.3 trebuie să fie egală cu col.4. Valoarea col.3: @c3, valoarea col.4: @c4', {
                    '@r': r,
                    '@c3': c3,
                    '@c4': c4
                })
...
// 45-004.1-F  Cap.I (FILIALE): Rând.1190 col.3 = col.4  și  Rând.1191 col.3 = col.4
function validate45_004_1_F(values) {
    ...
    for (var j = 0; j < values.CAP_NUM_FILIAL.length; j++) {
        ...
        for (var i = 0; i < rows.length; i++) {
            ...
            var arrC3 = values["CAP1_R" + r + "_C3_FILIAL"];
            var arrC4 = values["CAP1_R" + r + "_C4_FILIAL"];

            var c3 = roundToDecimal(NVAL(arrC3 && arrC3[j]), 1);
            var c4 = roundToDecimal(NVAL(arrC4 && arrC4[j]), 1);
            ...
            if (c3 !== c4) {
                webform.errors.push({
                    ...
                    'index': j,
                    'weight': 6,
                    'msg': Drupal.t('Raion: @CAP_CUATM_FILIAL - Cod eroare: 45-004.1-F. Rând.@r col.3 trebuie să fie egală cu col.4. Valoarea col.3: @c3, valoarea col.4: @c4', {
                        '@CAP_CUATM_FILIAL': CAP_CUATM_FILIAL,
                        '@r': r,
                        '@c3': c3,
                        '@c4': c4
